...
const SocialLoginButtons = ({ variant = "light" }: SocialLoginButtonsProps) => {
  ...
  const btnBase = isDark
    ? "h-14 w-full rounded-2xl border text-sm font-semibold transition-all duration-200 active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-3"
  ...
  const appleClasses = isDark
    ? `${btnBase} border-white/10 bg-white text-black hover:bg-white/90`
    : `${btnBase} border-border bg-foreground text-background`;
