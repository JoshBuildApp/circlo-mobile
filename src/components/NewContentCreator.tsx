...
const CONTENT_TYPES: ContentTypeOption[] = [
  ...
  { key: "text", icon: Type, title: "Post", desc: "Quick text update", color: "text-emerald-500", bg: "bg-emerald-500/10", gradient: "from-emerald-500 to-teal-600", coachOnly: false, needsMedia: false },
  ...
  <div className="flex items-center gap-2 px-5">
    {Array.from({ length: total }).map((_, i) => (
      <div key={i} className="flex-1 h-1 rounded-full overflow-hidden bg-muted/30">
        <motion.div
          className="h-full rounded-full bg-gradient-to-r from-[#00D4AA] to-[#00D4AA]/70"
          initial={{ width: "0%" }}
      ...
      <AnimatePresence mode="wait">
        ...
        {step === "details" && (
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-5 pt-4 pb-8 space-y-5">
              ...
              {previewUrl && (
                <div className="flex gap-4 items-start">
                  ...
                  <button
                    onClick={() => { setFile(null); if (previewUrl) URL.revokeObjectURL(previewUrl); setPreviewUrl(null); setStep("upload"); }}
            ...
            <div className="px-5 py-4 border-t border-border/10">
              <button
                onClick={() => selectedType === "story" ? handlePublish() : setStep("preview")}
                className="w-full bg-primary text-primary-foreground font-bold text-base py-4 rounded-2xl active:scale-[0.98] transition-transform"
              >
                {selectedType === "story" ? "Share Story" : "Preview"}
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-5 pt-4 pb-8">
              ...
              <div className="rounded-2xl bg-card border border-border/50 overflow-hidden">
                ...
                <div className="flex items-center gap-3 p-3">
                  <div className="h-10 w-10 rounded-full bg-gradient-to-br from-[#00D4AA] to-[#00D4AA]/60 flex items-center justify-center text-white text-sm font-bold">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {sportTag && (
                        <span className="px-1.5 py-0.5 rounded-full text-[8px] font-bold text-white uppercase tracking-wider bg-[#00D4AA]">
                          {sportTag}
                        </span>
                      )}
                    </div>
            ...
            <div className="px-5 py-4 border-t border-border/10">
              <button
                ...
                disabled={posting}
                className="w-full bg-gradient-to-r from-[#00D4AA] to-[#00D4AA]/80 text-white font-bold text-base py-4 rounded-2xl active:scale-[0.98] transition-transform disabled:opacity-50 shadow-lg shadow-[#00D4AA]/20"
              >
