  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      <div className="px-4 pt-4 pb-3 flex items-center gap-3">
        ...
        <h1 className="text-lg font-bold text-foreground">Case Study</h1>
      </div>
      ...
      <div className="px-4 space-y-6">
        <div className="flex items-start gap-3 p-4 rounded-2xl bg-amber-500/5 border border-amber-500/20">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Case study details aren't live yet. Route stub for <code className="text-[10px]">/case-studies/{id ?? ":id"}</code>.
            </p>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-border/10 bg-card p-5">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            Full case study — background, approach, results, and testimonial.
          </p>
        </div>
      </div>
    </div>
